  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          ...
          <motion.div 
            ...
            className="bg-slate-900 rounded-2xl p-8 text-white shadow-xl shadow-slate-200"
          >
            <div className="flex items-center gap-3 mb-6">
      ...
      <div className="fixed bottom-10 right-10 z-50">
        <button className="bg-accent text-white px-8 py-4 rounded-2xl font-bold shadow-2xl shadow-accent/40 flex items-center gap-3 hover:scale-105 transition-all">
          <Save size={20} />
          Save Changes
        </button>
      </div>

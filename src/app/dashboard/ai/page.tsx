        ...
        <AnimatePresence mode="wait">
          {!summaryData ? (
            <motion.div
              ...
              className="bg-white border border-slate-100 rounded-xl p-6 md:p-10 shadow-sm flex flex-col items-center justify-center overflow-hidden min-h-[400px] relative"
            >
              {/* Background Glow */}

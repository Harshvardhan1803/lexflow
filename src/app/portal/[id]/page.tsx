          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-slate-900 rounded-3xl p-8 text-white shadow-xl shadow-slate-900/20">
              ...
              <button 
                ...
                className="w-full py-3 bg-accent text-white rounded-2xl font-bold flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-0.98 transition-all shadow-lg shadow-accent/20"
              >
...
function StatusTimeline({ milestones }: { 
  ...
  return (
    <motion.div 
      ...
      className="bg-white rounded-2xl p-10 border border-slate-200 shadow-sm h-full"
    >
...
function DocumentView({ documents }: { 
  ...
  return (
    <motion.div 
      initial={{ opacity: 0, x: 20 }}
      animate={{ opacity: 1, x: 0 }}
      className="bg-white rounded-2xl p-10 border border-slate-200 shadow-sm h-full flex flex-col"
    >
      <div className="flex items-center justify-between mb-8">
        ...
        <button className="flex items-center gap-2 px-6 py-3 bg-slate-900 text-white rounded-2xl text-xs font-bold hover:bg-slate-800 transition-all shadow-xl shadow-slate-900/10">
      ...
      <div className="space-y-3">
        {documents.map((doc) => (
          <div key={doc.id} className="flex items-center justify-between p-4 rounded-2xl border border-slate-100 hover:border-accent/30 hover:bg-slate-50 transition-all group">
            <div className="flex items-center gap-4">
    ...
    >
      ...
      <div className="flex-1 space-y-4 overflow-y-auto mb-6 scrollbar-hide">
        <div className="flex justify-start">
          <div className="max-w-[80%] p-4 bg-slate-50 border border-slate-100 rounded-2xl rounded-tl-none">
      ...
      <div className="relative">
        <textarea 
          ...
          className="w-full bg-slate-50 border border-slate-100 rounded-3xl p-6 pr-16 text-sm font-medium outline-none focus:ring-2 focus:ring-accent/10 focus:border-accent transition-all resize-none"
          rows={3}
          value={msg}

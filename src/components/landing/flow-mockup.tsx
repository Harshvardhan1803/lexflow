  ...
  return (
    <div ref={containerRef} className="relative w-full aspect-square flex items-center justify-center p-4">
      ...
      <div className="absolute top-[10%] left-1/2 -translate-x-1/2 flex flex-col items-center">
        <div className="node node-intake w-12 h-12 rounded-2xl bg-white border border-slate-200 shadow-xl flex items-center justify-center text-accent relative">
          <Bot size={22} />
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
        <div className="node node-ai w-20 h-20 rounded-3xl bg-slate-900 shadow-[0_0_50px_rgba(192,133,82,0.15)] flex items-center justify-center text-white relative border-2 border-brand-soft z-20">
        ...
        <div className="feature-card feature-ai mt-6 glass px-6 py-3 rounded-2xl border-brand-soft shadow-2xl z-20">
